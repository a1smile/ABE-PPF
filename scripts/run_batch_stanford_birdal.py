...
from ppf.birdal_revisited import run_birdal_revisited_registration
...
def process_one(task):
    ...
    try:
        ...
        T_pred, out_model, debug, stats = run_birdal_revisited_registration(
...
def main():
    ap = argparse.ArgumentParser(description="Stanford batch runner for the Birdal Revisited reproduction.")
    ap.add_argument("--config", type=str, default="configs/Stanford/birdal_revisited_stanford.yaml")
    ...
    ap.add_argument("--out_prefix", type=str, default="stanford_birdal_revisited")
    ...
    logger.info("Method: Birdal Revisited")
